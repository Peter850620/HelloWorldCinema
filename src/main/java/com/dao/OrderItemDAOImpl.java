...
public class OrderItemDAOImpl implements OrderItemDAO {
	...
	public int cancel(String seatNo, Integer bookingNo) {
		...
		Query<OrderItem> query = getSession().createQuery(hql, OrderItem.class).setParameter("seatNo", seatNo)
	...
	public List<OrderItem> findSeatByBookingNo(Integer bookingNo) {
	    String hql = "from OrderItem where booking.bookingNo = :bookingNo";
	    Query<OrderItem> query = getSession().createQuery(hql, OrderItem.class);
	    return query.setParameter("bookingNo", bookingNo).list();
	}
